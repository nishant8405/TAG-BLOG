...
//            out.println("<body>");
            ...
            User user = udao.fetchUserByEmailAndPassword(userEmail, userPassword);
            
//            out.println(userPassword);
//            out.println(user.getPassword());

            if (user == null) {
                Message m = new Message("Invalid Credentials...Try again!!!","error","alert-danger");
